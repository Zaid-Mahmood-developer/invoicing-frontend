...
const CreditNote = () => {
  ...
  //   setEditIndex(index);
  //   setEditQuantity(Math.abs(items[index].quantity)); // show positive qty for editing
  // };
  ...
  //   const negativeQty = -Math.abs(editQuantity);
  ...
  //     invoiceRefNo: findSpecificInvoice.invoiceRefNo,
...
>
    ...
    >
        Credit Note Module – In Progress
    </h3>
    ...
    >
        **The Credit Note feature is currently under active development.  
        Our team is working with priority to deliver a robust and seamless experience.  
